namespace UniversityCatolic.Migrations
{
    ...
    public partial class ComplexDataModel : DbMigration
    {
        public override void Up()
        {
            ...
            // Create  a department for course to point to. / Cree un departamento al que apuntará el curso
            Sql("INSERT INTO dbo.Department (Name, Budget, StartDate) VALUES ('Temp', 0.00, GETDATE())");
            //default value for FK points to department created above. / valor predeterminado para puntos FK al departamento creado anteriormente
